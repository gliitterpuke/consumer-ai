...
class PersonalityCreator {
    private selectedOption: 'random' | 'custom' | null = null;
    private currentPersonality: PersonalityData | null = null;
    private randomPersonalities: RandomPersonalityPool;
    ...
    private initializeEventListeners(): void {
        // Option selection
        const randomOption = document.getElementById('random-option') as HTMLElement;
        const customOption = document.getElementById('custom-option') as HTMLElement;
        ...
        // Random generation
        const generateRandomBtn = document.getElementById('generate-random') as HTMLButtonElement;
        ...
        const aiPersonalityInput = document.getElementById('ai-personality') as HTMLTextAreaElement;
        const aiBackstoryInput = document.getElementById('ai-backstory') as HTMLTextAreaElement;
        const aiResponseStyleInput = document.getElementById('ai-response-style') as HTMLTextAreaElement;
        ...
        // Emoji picker
        document.querySelectorAll('.emoji-option').forEach((btn: Element) => {
            const button = btn as HTMLButtonElement;
            button.addEventListener('click', () => {
                document.querySelectorAll('.emoji-option').forEach((b: Element) => 
        ...
        // Sliders
        this.setupSlider('response-frequency', 'freq-value', (value: number) => `${value}%`);
        this.setupSlider('response-speed', 'speed-value', (value: number) => {
        ...
        this.setupSlider('chattiness', 'chat-value', (value: number) => {
        ...
        this.setupSlider('empathy', 'empathy-value', (value: number) => {
        ...
        const createBtn = document.getElementById('create-personality') as HTMLButtonElement;
        createBtn?.addEventListener('click', () => {
            this.createPersonality();
        });
    }

    private setupSlider(sliderId: string, valueId: string, formatter: (value: number) => string): void {
    ...
    private selectOption(option: 'random' | 'custom'): void {
        this.selectedOption = option;
        
        // Update UI
        document.querySelectorAll('.option-card').forEach((card: Element) => {
        ...
        const customForm = document.getElementById('custom-form') as HTMLElement;
        const randomPreview = document.getElementById('random-preview') as HTMLElement;
    ...
    private generateRandomPersonalityPool(): RandomPersonalityPool {
        const names = [
    ...
    private updateRandomPreview(): void {
        ...
        const randomAvatar = document.getElementById('random-avatar') as HTMLElement;
        const randomName = document.getElementById('random-name') as HTMLElement;
        const randomDescription = document.getElementById('random-description') as HTMLElement;

        if (randomAvatar) randomAvatar.textContent = this.currentPersonality.avatar;
        if (randomName) randomName.textContent = this.currentPersonality.name;
        if (randomDescription) randomDescription.textContent = this.currentPersonality.personality;
    }
    ...
    private updatePreview(): void {
        ...
        const responseFrequencySlider = document.getElementById('response-frequency') as HTMLInputElement;
        const responseSpeedSlider = document.getElementById('response-speed') as HTMLInputElement;
        const chattinessSlider = document.getElementById('chattiness') as HTMLInputElement;
        const empathySlider = document.getElementById('empathy') as HTMLInputElement;
        ...
        const previewAvatar = document.getElementById('preview-avatar') as HTMLElement;
        ...
        const previewBackstory = document.getElementById('preview-backstory') as HTMLElement;
        const previewStyle = document.getElementById('preview-style') as HTMLElement;
